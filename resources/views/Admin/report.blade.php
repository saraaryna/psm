...
@section('contents')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Student by Faculty</h5>
            ...
            <div class="col-md-6 mt-md-0 mt-3"> <!-- Adjusted column class -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Student by Year</h5>
                        <canvas id="yearChart" style="height: 300px;"></canvas>
                        <div id="yearTable" style="display: none;">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>Label</th>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function mapFacultyNamesToAbbreviations(label) {
                ...
                // Return the abbreviation if found, otherwise return the original label
                return facultyAbbreviations[label] || label;
            }

            // Replace facultyLabels with abbreviated names
            var abbreviatedFacultyLabels = facultyLabels.map(mapFacultyNamesToAbbreviations);

            var facultyChart = new Chart(ctxFaculty, {
                type: 'bar',
                data: {
                    labels: abbreviatedFacultyLabels,
                    datasets: [{
